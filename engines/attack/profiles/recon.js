...
const SENSITIVE_PATHS = [
  ...
  { path: '/wp-config.php.bak', label: 'Backup wp-config.php',  severity: 'critical' },
  { path: '/wp-config.old',    label: 'Backup wp-config.php',  severity: 'critical' },
  { path: '/wp-content/debug.log', label: 'WordPress Debug Log', severity: 'high'     },
  { path: '/xmlrpc.php',       label: 'WordPress XML-RPC',     severity: 'medium'   },
  { path: '/wp-json/wp/v2/users', label: 'WP User Enumeration',  severity: 'medium'   },
